class CanvasPrinter{
    ...
    drawStartImage(){
        ...
        if (lastR !== null) this.drawGraph(parseInt(lastR));
        this.drawAxes();
    ...
    parseClick(event){
        ...
        if(document.getElementById("R-input").value == null) {
            Swal.fire({
        ...
        sendPoint(x.toFixed(3), y.toFixed(3), document.getElementById("R-input").value)
        location.reload()
    }
